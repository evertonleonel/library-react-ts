...
Este Projeto foi construido como forma de estudo. Conhecimentos aplicados: TypeScript, MUI e Axios. Nesta aplicação você poderá: cadastrar, editar, emprestar e devolver livros, entre outras ações.
...
Configure seu package.json - Em 'scripts' acicione o código abaixo:
...
Inicie aplicação pelo terminal
...
Abra o Browser e acesse 'http://localhost:5000/', ou utilize o localhost indicado no seu terminal.
